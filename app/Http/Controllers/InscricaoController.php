...
class InscricaoController extends Controller
{
    ...
    {
        return json_encode(Inscricao::loadInscricaoByPessoaId($pessoa_fisica_id));
    }

    public function destroy(Request $request, $pessoa_fisica_id)
    {
        $inscricao = Inscricao::loadInscricaoByPessoaId($pessoa_fisica_id);
